...
function finalScore(scoreFunction, gameLength) {
    const gameScore = {Home: 0, Away: 0}
    for (let i = 0; i < gameLength; i++) {
        gameScore.Home += scoreFunction();
        gameScore.Away += scoreFunction();
    }
    return gameScore;
}
...
function getInningScore(scoreFunction) {
    const inningScore = {Home: scoreFunction(), Away: scoreFunction()};
    return inningScore;
}
